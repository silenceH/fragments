...
collect_bioisosteres_greedy(file_1,file_2,file_3,file_4,file_5,file_6,file_7,file_8,file_9,file_10)
...
#get_bioisosteres(file_3, noHs=True, brics=True, kennewell = True, overlap = False, test = False)
#get_bioisosteres(file_4, noHs=True, brics=True, kennewell = True, overlap = False, test = False)
#get_bioisosteres(file_5, noHs=True, brics=True, kennewell = True, overlap = False, test = False)
#get_bioisosteres(file_6, noHs=True, brics=True, kennewell = True, overlap = False, test = False)
#get_bioisosteres(file_7, noHs=True, brics=True, kennewell = True, overlap = False, test = False)
#get_bioisosteres(file_8, noHs=True, brics=True, kennewell = True, overlap = False, test = False)
#get_bioisosteres(file_9, noHs=True, brics=True, kennewell = True, overlap = False, test = False)
...
#two_dim_similars(file_1, 0.7,full_screen=True)
#two_dim_similars(file_2, 0.7,full_screen=True)
#two_dim_similars(file_3, 0.7,full_screen=True)
#two_dim_similars(file_4, 0.7,full_screen=True)
#two_dim_similars(file_5, 0.7,full_screen=True)
#two_dim_similars(file_6, 0.7,full_screen=True)
#two_dim_similars(file_7, 0.7,full_screen=True)
#two_dim_similars(file_8, 0.7,full_screen=True)
#two_dim_similars(file_9, 0.7,full_screen=True)
#two_dim_similars(file_10, 0.7,full_screen=True)
